# 🚀 DermaAI Master E2E & Security Test Execution Report

### Overall Status: 🟢 **PASS**

> 📊 **[Click Here to Open Complete Interactive Report on GitHub Pages](https://Sandeepreddy1006.github.io/DermaAI/report.html)**
...
| **Build Number** | #5 |
| **Branch / Commit** | `main` (`96e4063`) |
| **Execution Date** | 2026-08-27 05:05:24 UTC |
...
|---|---|---|---|---|---|---|
| 📱 **Mobile Frontend (Appium)** | `460` | `445` | `12` | `3` | `96.74%` | 🟢 PASSED |
| 🌐 **Web Frontend (Selenium)** | `415` | `401` | `11` | `3` | `96.63%` | 🟢 PASSED |
| ⚙️ **Backend (Functional API)** | `405` | `393` | `9` | `3` | `97.04%` | 🟢 PASSED |
| 🔒 **Security Test (SAST/DAST)** | `420` | `402` | `15` | `3` | `95.71%` | 🟢 PASSED |
| ⚡ **Load Testing (k6/Performance)** | `410` | `395` | `12` | `3` | `96.34%` | 🟢 PASSED |
| **OVERALL COMBINED** | **`2110`** | **`2036`** | **`59`** | **`15`** | **`96.49%`** | 🟢 **PASSED GATE** |
...
- 📊 **[Interactive HTML Report on GitHub Pages](https://Sandeepreddy1006.github.io/DermaAI/report.html)**
